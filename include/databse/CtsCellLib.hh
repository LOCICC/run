...
class CtsCellLib
{
 public:
  ...
  CtsCellLib(const std::string& cell_master, const double init_cap):_cell_master(cell_master),_init_cap(init_cap){}
  ~CtsCellLib() = default;
  // get
...
class CtsLibs
{
 public:
  ...
  static std::unordered_map<std::string, CtsCellLib*> _lib_maps;
};
}  // namespace icts